...
<template>
  <div style="width: 300px; border: 1px solid #d9d9d9; border-radius: 4px">
    <o-calendar :fullscreen="false" :header-render="headerRender" @panelChange="onPanelChange" />
  </div>
</template>
<script>
export default {
          ...
          <o-row type="flex" justify="space-between">
            <o-col>
              <o-radio-group size="small" onChange={e => onTypeChange(e.target.value)} value={type}>
                <o-radio-button value="month">Month</o-radio-button>
                <o-radio-button value="year">Year</o-radio-button>
              </o-radio-group>
            </o-col>
            <o-col>
              <o-select
