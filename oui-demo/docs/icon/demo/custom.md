...
<us>
#### Custom Icon
Create a reusable Vue component by using `<o-icon :component="{...}" />`. The property `component` takes a Vue component that renders to `svg` element.
</us>
