<template>
  <div ref="table" :id="id" class="advanced-table">
    ...
    <div :class="['header-bar', size]">
      ...
      <div class="actions">
        <o-tooltip title="刷新">
          <o-icon @click="refresh" class="action" :type="loading ? 'loading' : 'reload'" />
        </o-tooltip>
        ...
        <o-tooltip title="全屏">
          <o-icon @click="toggleScreen" class="action" :type="fullScreen ? 'fullscreen-exit' : 'fullscreen'" />
        </o-tooltip>
      </div>
    </div>
    <o-table
