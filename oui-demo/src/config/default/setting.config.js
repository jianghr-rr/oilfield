...
module.exports = {
  ...
  systemName: 'XInjiang Userty Design Pro',         //系统名称
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'http://81.70.148.10:4873/', name: 'Pro首页'},
    {link: 'https://github.com/jianghaoran116/oilfield', icon: 'github'},
    {link: 'http://81.70.148.10:4873/', name: 'Userty Design'}
  ],
}
