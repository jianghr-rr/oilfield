<template>
  <div>
    <h1>
      ...
      <o-tooltip title="发送邮件到：antdv@foxmail.com">
        <a href="mailto:antdv@foxmail.com"> 我们 </a>
      </o-tooltip>
      ！！！
    </h1>
    <div style="margin-top: 30px;">
      <o-list item-layout="vertical" size="large" :data-source="list">
        <o-list-item v-show="isEffective(item.effectiveTime)" slot="renderItem" slot-scope="item">
          <o-list-item-meta>
            ...
            <div>
              <o-tooltip title="发送邮件到：antdv@foxmail.com">
                <a :href="`mailto:antdv@foxmail.com?subject=应聘 ${item.id} 职位`">
                  <o-icon type="link" style="margin-right: 8px" />
                  立刻申请
                </a>
              </o-tooltip>
