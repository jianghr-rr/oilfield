      ...
      return h(
        ...
        [h(
          ...
          [h(
            'svg',
            {
              attrs: { t: '1637251477741', viewBox: '0 0 1024 1024', version: '1.1', xmlns: 'http://www.w3.org/2000/svg', 'p-id': '926' },
              'class': 'svg' },
            [h('path', {
              attrs: { d: 'M500.992 600.576c-0.256 0.512-0.256 1.024-0.512 1.536-24.832 96.512-49.92 193.024-74.752 289.28h0.256c-8.704 41.728 14.08 84.48 55.04 99.84 45.312 16.896 96-6.144 112.896-51.456 5.632-15.36 6.912-30.976 4.096-46.08a9.088 9.088 0 0 1-0.512-2.56l-0.768-3.84-63.744-284.672v-0.512c-1.28-5.12-5.12-9.472-10.496-11.52a16.998 16.998 0 0 0-21.504 9.984z', 'p-id': '927' }
            })]
          )]
        ), h(
          'i',
