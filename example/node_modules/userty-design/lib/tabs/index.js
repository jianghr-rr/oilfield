...
_tabs2['default'].TabPane = (0, _extends3['default'])({}, _TabPane2['default'], { name: 'OTabPane', __ANT_TAB_PANE: true });
_tabs2['default'].TabContent = (0, _extends3['default'])({}, _TabContent2['default'], { name: 'OTabContent' });
