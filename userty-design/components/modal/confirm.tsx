...
import {MultiToneSuccess, MultiToneError, FilledInfo, FilledWarn} from '@ant-design/icons';
...
export function withInfo(props: ModalFuncProps): ModalFuncProps {
    return {
        icon: <FilledInfo width={22} height={22} color={'#2468f2'}/>,
        okCancel: false,
        ...props,
        type: 'info'
    };
...
export function withSuccess(props: ModalFuncProps): ModalFuncProps {
    return {
        icon: <MultiToneSuccess width={22} height={22}/>,
        okCancel: false,
        ...props,
        type: 'success'
    };
...
export function withError(props: ModalFuncProps): ModalFuncProps {
    return {
        icon: <MultiToneError width={22} height={22} />,
        okCancel: false,
        ...props,
        type: 'error'
    };
