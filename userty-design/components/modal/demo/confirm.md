...
```jsx
import {Modal, Button, Space} from 'skd';
...
function showConfirm() {
  confirm({
    ...
    content: 'Some descriptions,Some descriptionsSome descriptions,Some descriptions,Some descriptions,Some descriptionsSome descriptionsSome descriptionsSome',
    onOk() {
      console.log('OK');
      },
    onCancel() {
