...
function InnerRangePicker<DateType>(props: RangePickerProps<DateType>) {
    ...
    const [, onStartEnter, onStartLeave] = useHoverValue(startText, {
        formatList,
        generateConfig,
        locale,
    });

    const [, onEndEnter, onEndLeave] = useHoverValue(endText, {
        formatList,
        generateConfig,
        locale,
    });
            ...
            >
                <div
                    ...
                    className={classNames(prefixCls, `${prefixCls}-range`, className, {
                        ...
                        [`${prefixCls}-range-has-value`]: startText.length && endText.length
                    })}
                    style={style}
