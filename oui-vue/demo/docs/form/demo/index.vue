...
#### 如需要使用 \`v-model\` 双向绑定式的校验功能可使用新的表单 [\`o-form-model\`](/components/form-model-cn/)。
...
#### If you need to use \`v-model\` verification, you can use new form [\`o-form-model\`](/components/form-model/)。
